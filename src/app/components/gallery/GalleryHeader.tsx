    ...
    <section className="relative min-h-[650px] lg:min-h-[700px] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <iframe
          ...
          title="Europe Enchanted Gallery"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p
              ...
              "
            >
              Explore moments from Europe Enchanted — from sun-drenched
              beachfront bungalows and turquoise waters to serene sunsets
              and authentic Khmer cuisine.
            </p>
          </motion.div>
        </div>
      </div>
