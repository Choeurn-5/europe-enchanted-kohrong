...
const defaultGalleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    alt: 'Panoramic ocean view from resort balcony',
    title: 'Sunrise Over Koh Rong Waters',
    category: 'beach',
  ...
  },
  {
    ...
    title: 'Infinity Pool & Loungers',
    category: 'dining',
    categoryLabel: 'Dining & Leisure',
    span: 'tall',
  },
  {
    id: 'g5',
    src: '/intro-bungalow.jpg',
    alt: 'Island tour speedboat on turquoise waters',
    title: 'Island Snorkeling & Boat Cruise',
    category: 'activities',
  ...
  },
  {
    id: 'g6',
    src: '/images/resort-4.jpg',
    alt: 'Tropical open-air dining at sunset',
    title: 'Fresh Seafood by the Shore',
    category: 'dining',
    categoryLabel: 'Dining & Leisure',
    span: 'wide',
  },
  {
    id: 'g7',
    src: '/intro-bungalow.jpg',
    alt: 'Lush tropical resort pathway',
    title: 'Garden Walkways & Palm Canopy',
    category: 'beach',
    categoryLabel: 'Beach & Ocean',
    span: 'normal',
  },
  {
    id: 'g8',
    src: '/images/resort-4.jpg',
    alt: 'Sunset glow over the Cambodian coast',
    title: 'Twilight Over the Gulf of Thailand',
    category: 'beach',
    categoryLabel: 'Beach & Ocean',
    span: 'normal',
  },
  {
    ...
    title: 'Nightly Beachside Gathering',
    category: 'activities',
    categoryLabel: 'Island Life',
    span: 'wide',
  },
...
const categories = [
  ...
  { key: 'dining', label: 'Dining & Leisure' },
